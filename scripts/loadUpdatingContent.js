function update(){        
        document.getElementById("top_bar").innerHTML = '<a href="https://asherhausam.com">'+
    ...
    '<a href="/sitemap/"><span class="mso fit">menu</span>more</a>';
        ...
        document.getElementById("socials").innerHTML = '<a href="https://www.linkedin.com/in/asher-hausam-208a2021a/"><span class="mso fit">work</span>LinkedIn</a>'+
    ' | '+
